...
pub fn render() {
    ...
    for &(r, g, b) in PULSES {
        write!(
            err,
            "\r  \x1b[38;2;{r};{g};{b}m\x1b[1m\u{25c8} nameless\x1b[0m"
        )
        .ok();
        err.flush().ok();
    ...
    let p = ansi_fg(PLUM);
    eprintln!("  {p}{ANSI_DIM}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}{ANSI_RESET}");
}
