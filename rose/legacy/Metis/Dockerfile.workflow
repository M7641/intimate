...
RUN useradd -m -d /home/app-user -u $APP_USER_ID app-user
...
RUN git config --global url."https://${GITHUB_TOKEN_GITHUB}@github.com/".insteadOf "https://github.com/" \
    ...
    && python -m pip install --no-cache-dir metis@git+https://github.com/nimbus-labs/ds-Metis@main \
    && git config --global --unset url."https://${GITHUB_TOKEN_GITHUB}@github.com/".insteadOf


ENV PATH="${PATH}:/home/app-user/.local/bin"
